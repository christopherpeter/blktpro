...
function loadsectionfilter() {
    ...
    if (view === 'yes') {
        ...
        $.ajax({
            type: "GET",
            crossDomain: true,
            url: BlackmanApplicationServices.NewCategoryServiceURL + "hsCode=&secCode=&groupCode=&catCode=&deviceEncryptedkey=" + encryptedkey + "&spLib=" + BlackmanApplicationVariables.splib + "&tableLib=" + BlackmanApplicationVariables.tablelib,
            dataType: "xml",
...
function filterkitchensub(sectioncode, groupcode, x) {
    ...
    $.ajax({
        type: "GET",
        crossDomain: true,
        url: BlackmanApplicationServices.categoryURL + "?SCode=" + sectioncode + "&GCode=" + groupcode + "&deviceencryptedkey=" + encryptedkey + "&splib=" + BlackmanApplicationVariables.splib + "&tablelib=" + BlackmanApplicationVariables.tablelib,
        dataType: "xml",
        success: function (xmlData) {
            var xmlString;
            if (window.ActiveXObject) {
...
function productListingFinal(HSCODE, sectioncode, groupcode, DESCRIPTIONlast) {
    ...
    $.ajax({
        type: "GET",
        crossDomain: true,
        url: BlackmanApplicationServices.NewCategoryServiceURL + "hsCode=" + HSCODE + "&secCode=" + sectioncode + "&groupCode=" + groupcode + "&catCode=&deviceEncryptedkey=" + encryptedkey + "&spLib=" + BlackmanApplicationVariables.splib + "&tableLib=" + BlackmanApplicationVariables.tablelib,
        dataType: "xml",
        success: function (xmlData) {
            var xmlString;
            if (window.ActiveXObject) {
